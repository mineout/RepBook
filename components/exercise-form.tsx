...
import { getFilteredExerciseSuggestions } from "@/lib/exercise-suggestion-filter";
...
export function ExerciseForm({
  ...
  const visibleSuggestions = useMemo(
    () =>
      getFilteredExerciseSuggestions(exerciseSuggestions, exerciseName),
    [exerciseName, exerciseSuggestions],
  );
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        {statusMessage && (
          <div
            className={`mb-6 rounded-xl border px-4 py-3 text-sm ${status === "error"
